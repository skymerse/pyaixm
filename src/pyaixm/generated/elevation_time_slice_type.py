...
from pyaixm.generated.elevation_time_slice_type_extension import (
    ElevationTimeSliceTypeExtension,
)
...
@dataclass
class ElevationTimeSliceType(AbstractAixmtimeSliceType):
    ...
    angle_nominal: Optional[ValAngleType] = field(
        default=None,
        metadata={
            "name": "angleNominal",
            "type": "Element",
    ...
    angle_minimum: Optional[ValAngleType] = field(
        default=None,
        metadata={
            "name": "angleMinimum",
            "type": "Element",
    ...
    angle_span: Optional[ValAngleType] = field(
        default=None,
        metadata={
            "name": "angleSpan",
            "type": "Element",
    ...
    extension: Iterable[ElevationTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
