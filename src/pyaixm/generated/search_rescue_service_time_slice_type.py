...
from pyaixm.generated.code_service_sartype import CodeServiceSartype
...
from pyaixm.generated.search_rescue_service_time_slice_type_extension import (
    SearchRescueServiceTimeSliceTypeExtension,
)
...
@dataclass
class SearchRescueServiceTimeSliceType(AbstractAixmtimeSliceType):
    ...
    type_value: Optional[CodeServiceSartype] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    extension: Iterable[SearchRescueServiceTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
