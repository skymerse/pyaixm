...
from pyaixm.generated.code_service_ground_control_type import (
...
from pyaixm.generated.ground_traffic_control_service_time_slice_type_extension import (
    GroundTrafficControlServiceTimeSliceTypeExtension,
)
...
@dataclass
class GroundTrafficControlServiceTimeSliceType(AbstractAixmtimeSliceType):
    ...
    type_value: Optional[CodeServiceGroundControlType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    client_airport: Optional[AirportHeliportPropertyType] = field(
        default=None,
        metadata={
            "name": "clientAirport",
            "type": "Element",
    ...
    extension: Iterable[GroundTrafficControlServiceTimeSliceTypeExtension] = (
        field(
            default_factory=list,
            metadata={
                "type": "Element",
