...
from pyaixm.generated.aerial_refuelling_point_type_extension import (
    AerialRefuellingPointTypeExtension,
)
from pyaixm.generated.airport_heliport_property_type import (
    AirportHeliportPropertyType,
)
from pyaixm.generated.code_aerial_refuelling_point_type import (
...
@dataclass
class AerialRefuellingPointType(AbstractSegmentPointType):
    ...
    sequence: Optional[NoSequenceType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    usage_type: Optional[CodeAerialRefuellingPointType] = field(
        default=None,
        metadata={
            "name": "usageType",
            "type": "Element",
    ...
    extension: Iterable[AerialRefuellingPointTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
