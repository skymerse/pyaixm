...
from pyaixm.generated.code_ilsback_course_type import CodeIlsbackCourseType
...
from pyaixm.generated.localizer_time_slice_type_extension import (
    LocalizerTimeSliceTypeExtension,
)
...
@dataclass
class LocalizerTimeSliceType(AbstractAixmtimeSliceType):
    ...
    magnetic_bearing_accuracy: Optional[ValAngleType] = field(
        default=None,
        metadata={
            "name": "magneticBearingAccuracy",
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
            "nillable": True,
        },
    ...
    declination: Optional[ValMagneticVariationType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    width_course: Optional[ValAngleType] = field(
        default=None,
        metadata={
            "name": "widthCourse",
            "type": "Element",
    ...
    width_course_accuracy: Optional[ValAngleType] = field(
        default=None,
        metadata={
            "name": "widthCourseAccuracy",
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
            "nillable": True,
        },
    )
    back_course_usable: Optional[CodeIlsbackCourseType] = field(
        default=None,
        metadata={
            "name": "backCourseUsable",
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
            "nillable": True,
        },
    )
    extension: Iterable[LocalizerTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
