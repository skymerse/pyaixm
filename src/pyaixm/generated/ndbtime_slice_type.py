...
from pyaixm.generated.code_emission_band_type import CodeEmissionBandType
from pyaixm.generated.code_navaid_designator_type import (
    CodeNavaidDesignatorType,
)
from pyaixm.generated.code_ndbusage_type import CodeNdbusageType
...
from pyaixm.generated.ndbtime_slice_type_extension import (
    NdbtimeSliceTypeExtension,
)
...
@dataclass
class NdbtimeSliceType(AbstractAixmtimeSliceType):
    class Meta:
        name = "NDBTimeSliceType"
    ...
    class_value: Optional[CodeNdbusageType] = field(
        default=None,
        metadata={
            "name": "class",
            "type": "Element",
    ...
    emission_band: Optional[CodeEmissionBandType] = field(
        default=None,
        metadata={
            "name": "emissionBand",
            "type": "Element",
    ...
    extension: Iterable[NdbtimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
