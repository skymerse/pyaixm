...
from pyaixm.generated.apron_contamination_type_extension import (
    ApronContaminationTypeExtension,
)
...
@dataclass
class ApronContaminationType(AbstractSurfaceContaminationType):
    ...
    extension: Iterable[ApronContaminationTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
