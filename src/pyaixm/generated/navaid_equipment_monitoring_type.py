...
from pyaixm.generated.navaid_equipment_monitoring_type_extension import (
    NavaidEquipmentMonitoringTypeExtension,
)
...
@dataclass
class NavaidEquipmentMonitoringType(AbstractPropertiesWithScheduleType):
    ...
    monitored: Optional[CodeYesNoType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    extension: Iterable[NavaidEquipmentMonitoringTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
