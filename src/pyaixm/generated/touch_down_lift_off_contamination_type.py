...
from pyaixm.generated.touch_down_lift_off_contamination_type_extension import (
    TouchDownLiftOffContaminationTypeExtension,
)
...
@dataclass
class TouchDownLiftOffContaminationType(AbstractSurfaceContaminationType):
    ...
    extension: Iterable[TouchDownLiftOffContaminationTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
