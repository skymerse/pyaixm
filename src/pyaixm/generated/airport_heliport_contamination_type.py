...
from pyaixm.generated.airport_heliport_contamination_type_extension import (
    AirportHeliportContaminationTypeExtension,
)
...
@dataclass
class AirportHeliportContaminationType(AbstractSurfaceContaminationType):
    ...
    extension: Iterable[AirportHeliportContaminationTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
