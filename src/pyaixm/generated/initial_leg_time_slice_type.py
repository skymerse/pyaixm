...
from pyaixm.generated.initial_leg_time_slice_type_extension import (
    InitialLegTimeSliceTypeExtension,
)
...
@dataclass
class InitialLegTimeSliceType(AbstractAixmtimeSliceType):
    ...
    extension: Iterable[InitialLegTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
