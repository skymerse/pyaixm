...
from pyaixm.generated.code_missed_approach_type import CodeMissedApproachType
...
from pyaixm.generated.missed_approach_leg_time_slice_type_extension import (
    MissedApproachLegTimeSliceTypeExtension,
)
...
@dataclass
class MissedApproachLegTimeSliceType(AbstractAixmtimeSliceType):
    ...
    type_value: Optional[CodeMissedApproachType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    threshold_after_mapt: Optional[CodeYesNoType] = field(
        default=None,
        metadata={
            "name": "thresholdAfterMAPT",
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
            "nillable": True,
        },
    )
    height_mapt: Optional[ValDistanceVerticalType] = field(
        default=None,
        metadata={
            "name": "heightMAPT",
            "type": "Element",
    ...
    extension: Iterable[MissedApproachLegTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
