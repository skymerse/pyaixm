...
from pyaixm.generated.aircraft_stand_contamination_type_extension import (
    AircraftStandContaminationTypeExtension,
)
...
@dataclass
class AircraftStandContaminationType(AbstractSurfaceContaminationType):
    ...
    extension: Iterable[AircraftStandContaminationTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
