...
@dataclass
class StandardInstrumentArrivalTimeSliceType(AbstractAixmtimeSliceType):
    ...
    arrival: Optional[LandingTakeoffAreaCollectionPropertyType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    extension: Iterable[StandardInstrumentArrivalTimeSliceTypeExtension] = (
        field(
            default_factory=list,
            metadata={
                "type": "Element",
