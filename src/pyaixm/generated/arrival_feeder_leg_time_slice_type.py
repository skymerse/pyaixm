...
from pyaixm.generated.arrival_feeder_leg_time_slice_type_extension import (
    ArrivalFeederLegTimeSliceTypeExtension,
)
...
@dataclass
class ArrivalFeederLegTimeSliceType(AbstractAixmtimeSliceType):
    ...
    extension: Iterable[ArrivalFeederLegTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
