...
from pyaixm.generated.secondary_surveillance_radar_time_slice_type_extension import (
    SecondarySurveillanceRadarTimeSliceTypeExtension,
)
...
@dataclass
class SecondarySurveillanceRadarTimeSliceType(AbstractAixmtimeSliceType):
    ...
    transponder: Optional[CodeTransponderType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    autonomous: Optional[CodeYesNoType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    monopulse: Optional[CodeYesNoType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    extension: Iterable[SecondarySurveillanceRadarTimeSliceTypeExtension] = (
        field(
            default_factory=list,
            metadata={
                "type": "Element",
