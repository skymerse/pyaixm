...
from pyaixm.generated.airspace_layer_class_type_extension import (
    AirspaceLayerClassTypeExtension,
)
from pyaixm.generated.airspace_layer_property_type import (
    AirspaceLayerPropertyType,
)
from pyaixm.generated.code_airspace_classification_type import (
...
@dataclass
class AirspaceLayerClassType(AbstractPropertiesWithScheduleType):
    ...
    classification: Optional[CodeAirspaceClassificationType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    associated_levels: Iterable[AirspaceLayerPropertyType] = field(
        default_factory=list,
        metadata={
    ...
    extension: Iterable[AirspaceLayerClassTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
