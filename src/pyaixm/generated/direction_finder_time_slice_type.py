...
from pyaixm.generated.direction_finder_time_slice_type_extension import (
    DirectionFinderTimeSliceTypeExtension,
)
from pyaixm.generated.elevated_point_property_type import (
    ElevatedPointPropertyType,
)
from pyaixm.generated.information_service_property_type import (
...
@dataclass
class DirectionFinderTimeSliceType(AbstractAixmtimeSliceType):
    ...
    doppler: Optional[CodeYesNoType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    information_provision: Iterable[InformationServicePropertyType] = field(
        default_factory=list,
        metadata={
    ...
    extension: Iterable[DirectionFinderTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
