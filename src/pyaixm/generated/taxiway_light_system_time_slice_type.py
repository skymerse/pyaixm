...
from pyaixm.generated.taxiway_light_system_time_slice_type_extension import (
    TaxiwayLightSystemTimeSliceTypeExtension,
)
...
@dataclass
class TaxiwayLightSystemTimeSliceType(AbstractAixmtimeSliceType):
    ...
    position: Optional[CodeTaxiwaySectionType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    lighted_taxiway: Optional[TaxiwayPropertyType] = field(
        default=None,
        metadata={
            "name": "lightedTaxiway",
            "type": "Element",
    ...
    extension: Iterable[TaxiwayLightSystemTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
