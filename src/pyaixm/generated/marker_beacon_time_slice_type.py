...
from generated.code_aural_morse_type import CodeAuralMorseType
from generated.code_marker_beacon_signal_type import CodeMarkerBeaconSignalType
...
from generated.marker_beacon_time_slice_type_extension import (
    MarkerBeaconTimeSliceTypeExtension,
)
...
@dataclass
class MarkerBeaconTimeSliceType(AbstractAixmtimeSliceType):
    ...
    class_value: Optional[CodeMarkerBeaconSignalType] = field(
        default=None,
        metadata={
            "name": "class",
            "type": "Element",
    ...
    axis_bearing: Optional[ValBearingType] = field(
        default=None,
        metadata={
            "name": "axisBearing",
            "type": "Element",
    ...
    aural_morse_code: Optional[CodeAuralMorseType] = field(
        default=None,
        metadata={
            "name": "auralMorseCode",
            "type": "Element",
    ...
    extension: Iterable[MarkerBeaconTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
