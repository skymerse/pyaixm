...
from pyaixm.generated.fire_fighting_service_extension_1 import (
    FireFightingServiceExtension1,
)
from pyaixm.generated.fire_fighting_service_extension_2 import (
    FireFightingServiceExtension2,
)
...
@dataclass
class FireFightingServiceTimeSliceTypeExtension:
    class Meta:
        global_type = False

    fire_fighting_service_extension: Optional[
        FireFightingServiceExtension2
    ] = field(
        default=None,
        metadata={
    ...
    aixm_aero_schema_5_1_event_fire_fighting_service_extension: Optional[
        FireFightingServiceExtension1
    ] = field(
        default=None,
        metadata={
