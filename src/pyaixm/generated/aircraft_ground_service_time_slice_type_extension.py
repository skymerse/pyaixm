...
from pyaixm.generated.aircraft_ground_service_extension import (
    AircraftGroundServiceExtension,
)
...
@dataclass
class AircraftGroundServiceTimeSliceTypeExtension:
    class Meta:
        global_type = False

    aircraft_ground_service_extension: Optional[
        AircraftGroundServiceExtension
    ] = field(
        default=None,
        metadata={
            "name": "AircraftGroundServiceExtension",
            "type": "Element",
