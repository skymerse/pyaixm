...
from pyaixm.generated.code_vortype import CodeVortype
...
from pyaixm.generated.vortime_slice_type_extension import (
    VortimeSliceTypeExtension,
)
...
@dataclass
class VortimeSliceType(AbstractAixmtimeSliceType):
    class Meta:
        name = "VORTimeSliceType"
    ...
    type_value: Optional[CodeVortype] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    zero_bearing_direction: Optional[CodeNorthReferenceType] = field(
        default=None,
        metadata={
            "name": "zeroBearingDirection",
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
            "nillable": True,
        },
    ...
    extension: Iterable[VortimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
