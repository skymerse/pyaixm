...
@dataclass
class GeoBorderTimeSliceType(AbstractAixmtimeSliceType):
    ...
    type_value: Optional[CodeGeoBorderType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    border: Optional[CurvePropertyType2] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    extension: Iterable[GeoBorderTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
