...
from generated.code_procedure_fix_role_type import CodeProcedureFixRoleType
...
from generated.terminal_segment_point_type_extension import (
    TerminalSegmentPointTypeExtension,
)
...
@dataclass
class TerminalSegmentPointType(AbstractSegmentPointType):
    ...
    role: Optional[CodeProcedureFixRoleType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    lead_radial: Optional[ValBearingType] = field(
        default=None,
        metadata={
            "name": "leadRadial",
            "type": "Element",
    ...
    lead_dme: Optional[ValDistanceType] = field(
        default=None,
        metadata={
            "name": "leadDME",
            "type": "Element",
    ...
    indicator_facf: Optional[CodeYesNoType] = field(
        default=None,
        metadata={
            "name": "indicatorFACF",
            "type": "Element",
    ...
    extension: Iterable[TerminalSegmentPointTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
