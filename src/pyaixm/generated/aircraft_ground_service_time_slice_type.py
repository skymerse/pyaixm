...
from pyaixm.generated.aircraft_ground_service_time_slice_type_extension import (
    AircraftGroundServiceTimeSliceTypeExtension,
)
...
from pyaixm.generated.code_aircraft_ground_service_type import (
...
@dataclass
class AircraftGroundServiceTimeSliceType(AbstractAixmtimeSliceType):
    ...
    type_value: Optional[CodeAircraftGroundServiceType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    extension: Iterable[AircraftGroundServiceTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
