...
from generated.code_passenger_service_type import CodePassengerServiceType
...
from generated.passenger_service_time_slice_type_extension import (
    PassengerServiceTimeSliceTypeExtension,
)
...
@dataclass
class PassengerServiceTimeSliceType(AbstractAixmtimeSliceType):
    ...
    type_value: Optional[CodePassengerServiceType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Element",
    ...
    extension: Iterable[PassengerServiceTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
