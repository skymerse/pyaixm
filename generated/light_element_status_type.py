...
from generated.light_element_status_type_extension import (
    LightElementStatusTypeExtension,
)
...
@dataclass
class LightElementStatusType(AbstractPropertiesWithScheduleType):
    ...
    extension: Iterable[LightElementStatusTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
