...
@dataclass
class PrecisionApproachRadarTimeSliceType(AbstractAixmtimeSliceType):
    ...
    precision_approach_radar_type: Optional[CodePartype] = field(
        default=None,
        metadata={
            "name": "precisionApproachRadarType",
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
            "nillable": True,
        },
    ...
    slope_accuracy: Optional[ValAngleType] = field(
        default=None,
        metadata={
            "name": "slopeAccuracy",
            "type": "Element",
    ...
    reflector: Iterable[ReflectorPropertyType] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
    ...
    extension: Iterable[PrecisionApproachRadarTimeSliceTypeExtension] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.aixm.aero/schema/5.1",
